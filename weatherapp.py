...
def get_weather(city):
    API_key = "3570b7d0966bf841ddc97da715ae18a5"
...
city_entry = ttkbootstrap.Entry(root, font="Helvetica, 30")
city_entry.pack(pady=60)
...
location_label = tk.Label(root, font="Helvetica, 60")
location_label.pack(pady=70)
...
description_label = tk.Label(root, font="Helvetica, 40")
